...
export default function BookDetailsClient({ book, reviewCount, bookId }: BookDetailsClientProps) {
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl bg-background-muted p-4">
                ...
                <div className="mt-2 text-2xl font-bold">★ {formatNumber(book.rating, 1)}</div>
              </div>
              <div className="rounded-2xl bg-background-muted p-4">
